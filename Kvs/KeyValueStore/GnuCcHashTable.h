/// @file
/// @brief Defines and implements the Kvs::KeyValueStore::GnuCcHashTable class
...
class GnuCcHashTable : public TypedKeyValueStore<Key, Value>
{
public:
...
protected:
    ...
    __gnu_pbds::cc_hash_table<Key, Value, Hash> m_hashtable;
